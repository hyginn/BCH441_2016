# BCH441_2016.R
#
# Purpose:  Supporting scripts for BCH441 (Bioinformatics) at the
...
#
#  This is the master file that will be continuously updated throughout the term
#  to support your code development and R exercises.
#
#  If you wish to edit this code, save the edited version under a different
#  name. Otherwise you will have problems with git when you update the project
#  to a new version.
#
...
#
#  While this file itself should not be edited by you ...
